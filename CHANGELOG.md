...
- The skills table: help-center-markdown 0.2.5 and island-mode-server 0.1.3,
  wording releases that describe an audit finding by its shape and use
  neutral identifiers in a template.
